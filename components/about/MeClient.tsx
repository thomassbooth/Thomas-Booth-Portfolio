...
const MeClient = () => {
  ...
  return (
    <section>
      ...
      <div className = 'flex flex-col w-screen text-6xl opacity-20 overflow-x-hidden lg:overflow-x-visible'>
        <Cities />
      </div>
    </section>
  )
